# odin-recipes
This project is about recipes of **Shahi paneer, Samosa and Lemonade**.
It demonstrates the HTML and Git, Linux skills I have learned till now.

## Skills :
- Linux CLI
- Git and GitHub workflow
- Linking different web pages using links(anchor tag).
- How to write a good git commit message(I will improve this continuously as I learn more.) 
- Using different HTML tags like : ordered list ,unordered list,heading, paragraph etc.
...
- Lemonade image : https://shorturl.at/0lm73
